							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="role_name" value="<?php echo ($info["role_name"]); ?>" data-required="1" class="span6 m-wrap"/>
									...
									<div class="control-group">
										...
										<div class="controls">
										<?php if(is_array($pris)): foreach($pris as $key=>$v): if($v['parent_id'] == 0): ?><hr><?php endif; ?>
											<label class="checkbox line">
											<input type="checkbox" <?php if(in_array($v['id'],$pri_ids) ): ?>checked="checked"<?php endif; ?> value="<?php echo ($v["id"]); ?>" name="pri_ids[]"/><?php echo str_repeat("-",$v['level']*8); echo ($v["pri_name"]); ?>
