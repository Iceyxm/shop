								...
								<div class="clearfix">
									...
									<div class="btn-group">
										<a href="<?php echo U('Admin/admin_add');?>">
											<button id="" class="btn green">管理员添加<i class="icon-plus"></i></button>
										</a>
									</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										<?php if(is_array($lst)): foreach($lst as $key=>$v): ?><tr class="">
												...
												<td><?php echo ((isset($v["roles"]) && ($v["roles"] !== ""))?($v["roles"]):"暂未选取"); ?></td>
												<td><img src="<?php echo ($v["user_logo"]); ?>" title="没有图片" style="height:80px;" /></td>
