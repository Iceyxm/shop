						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										<a href="<?php echo U('Privilege/pri_add');?>">
											<button id="" class="btn green">添加权限<i class="icon-plus"></i></button>
										</a>
									</div>
								...
								<table class="table table-striped table-hover table-bordered" id="">
									...
									<tbody>
										<?php if(is_array($data)): foreach($data as $key=>$v): ?><tr class="">
												...
												<td><a class="" href="<?php echo U('pri_edit',array('id'=>$v['id']));?>">Edit</a></td>
												<td><a class="" href="javascript:;" data-id="<?php echo ($v["id"]); ?>" onclick="dels(<?php echo ($v["id"]); ?>)">Delete</a></td>
