							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="password" name="password" value="<?php echo ($info["password"]); ?>" data-required="1" class="span6 m-wrap"/>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											...
											<img src="<?php echo ($info["user_logo"]); ?>" style="height:80px;" />
									...
									<div class="control-group">
										...
										<div class="controls">
										<?php if(is_array($roles)): foreach($roles as $key=>$v): ?><label class="checkbox line">
											<input type="checkbox" value="<?php echo ($v["id"]); ?>" name="role_ids[]"  <?php if(in_array($v['id'],$info['role_ids'])){echo 'checked="checked"';} ?> /> <?php echo ($v["role_name"]); ?>
