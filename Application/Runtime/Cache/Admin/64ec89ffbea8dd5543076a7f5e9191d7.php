						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										<a href="<?php echo U('Goods/goods_add');?>">
											<button id="" class="btn green">添加订单<i class="icon-plus"></i></button>
										</a>
									</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
												<td><?php echo ($v["order_id"]); ?></td>
												<td><a href="<?php echo U('Order/detail',array('order_id'=>$v['order_id']));?>" style="color:blue;"><?php echo ($v["order_number"]); ?></a></td>
												<td><?php echo ($v["order_price"]); ?></td>
												<td><?php echo ($v['order_status']=='0' ? "<span class='label label-warning'>未付款</span>" : "<span class='label label-success'>已付款</span>"); ?></td>
												<td><?php echo ($v['is_send']=='是' ? "<span class='label label-success'>已发货</span>":"<span class='label label-error'>未发货</span>"); ?></td>
												<td><?php echo (date("Y-m-d H:i:s",$v["add_time"])); ?></td>
												<td><a class="" href="<?php echo U('Admin/Order/order_edit',array('id'=>$v['order_id']));?>" >Edit</a></td>
												<td><a class="delete" href="javascript:;" data-id="<?php echo ($v["order_id"]); ?>">Delete</a></td>
...
<span style="font-size: 16px;font-weight: bolder;color: #2ae876;">&nbsp;&nbsp;&nbsp;导出订单：</span>
<span style="display:block;width: 90px;margin-left: 20px;height: 45px;line-height: 45px;">
	<a href="<?php echo U('putExcel');?>" id="putData"><img src="<?php echo C('ADMIN_IMAGE_PATH');?>putdata.png"/></a><!--默认找的是当前所在控制器的putExcel()方法-->
</span>
<!-- END PAGE CONTAINER-->
		</div>
		<!-- END PAGE -->
...
<!-- END PAGE LEVEL PLUGINS -->
	...
	<script>
		c_url = "<?php echo U('Order/order_del','',false);?>";
