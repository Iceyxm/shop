...
<div class="page-container">
    ...
    <div class="page-sidebar nav-collapse collapse">
        ...
        <ul class="page-sidebar-menu">
            ...
            <li class="start <?php if(CONTROLLER_NAME == 'Goods'){echo 'active';} ?> ">
                <a href="javascript:;">
                    <i class="icon-cogs"></i>
                ...
                <ul class="sub-menu">
                    <li class="<?php if(ACTION_NAME == 'goods_list'){echo 'active';} ?>">
                        <a href="<?php echo U('Admin/Goods/goods_list');?>">商品列表</a>
                    </li>
                    <li class="<?php if(ACTION_NAME == 'goods_add'){echo 'active';} ?>">
                        <a href="<?php echo U('Admin/Goods/goods_add');?>">商品添加</a>
                    </li>
                </ul>
            </li>

            <li class="start <?php if(CONTROLLER_NAME == 'Category'){echo 'active';} ?> ">
                <a href="javascript:;">
            ...
            <li class="start <?php if(CONTROLLER_NAME == 'Admin'){echo 'active';} ?> ">
                <a href="javascript:;">
                    <i class="icon-user"></i>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="<?php if(ACTION_NAME == 'cadmin_add'){echo 'active';} ?>">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        <li>
                            <i class="icon-home"></i><?php echo ($titles["name"]); ?>
							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" class="form-horizontal" method="post" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="cat_name" data-required="1" class="span6 m-wrap" value="<?php echo ($info["cat_name"]); ?>"/>
											<input type="hidden" name="id" data-required="1" class="span6 m-wrap" value="<?php echo ($info["id"]); ?>"/>
										</div>
									</div>
