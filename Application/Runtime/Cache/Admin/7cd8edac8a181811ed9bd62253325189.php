								...
								<div class="clearfix">
									...
									<div class="btn-group">
										<a href="<?php echo U('Admin/admin_add');?>">
											<button id="" class="btn green">角色添加<i class="icon-plus"></i></button>
										</a>
									</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										<?php if(is_array($lst)): foreach($lst as $key=>$v): ?><tr class="">
												...
												<td><?php echo ((isset($v["pri_name"]) && ($v["pri_name"] !== ""))?($v["pri_name"]):"以前添的，还没有权限"); ?></td>
												<td><a class="" href="<?php echo U('role_edit',array('id'=>$v['id']));?>">Edit</a></td>
