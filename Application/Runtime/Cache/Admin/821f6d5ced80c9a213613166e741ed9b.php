							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" class="form-horizontal" method="post" >
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="parent_id">
												...
												<?php if(is_array($data)): foreach($data as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo str_repeat("-",$v['level']*8); echo ($v["pri_name"]); ?></option><?php endforeach; endif; ?>
											</select>
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="module_name" data-required="1" class="span6 m-wrap" value="Admin"/>
										</div>
									</div>
									<div class="control-group">
