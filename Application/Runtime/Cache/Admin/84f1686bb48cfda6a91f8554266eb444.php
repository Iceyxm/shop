						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										<a href="<?php echo U('Goods/goods_add');?>">
											<button id="" class="btn green">添加商品<i class="icon-plus"></i></button>
										</a>
									</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										<!--<?php if(is_array($lst)): foreach($lst as $key=>$v): ?>-->
											<!--<tr class="">-->
												<!--<td><?php echo ($v["id"]); ?></td>-->
												<!--<td><?php echo ($v["goods_name"]); ?></td>-->
												<!--<td><?php echo ($v["goods_price"]); ?></td>-->
												<!--<td><?php echo ($v["goods_desc"]); ?></td>-->
												<!--<td><img src="<?php echo ($v["sm_logo"]); ?>" title="没有图片" style="height:80px;" /></td>-->
												<!--<td><a class="edit" href="javascript:;">Edit</a></td>-->
												<!--<td><a class="delete" href="javascript:;" data-id="<?php echo ($v["id"]); ?>">Delete</a></td>-->
											<!--</tr>-->
										<!--<?php endforeach; endif; ?>-->
										<?php if(is_array($lst)): $i = 0; $__LIST__ = $lst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="">
												<td><?php echo ($v["id"]); ?></td>
												<td><?php echo ($v["goods_name"]); ?></td>
												<td style="color: #2ae876;font-size: large;font-weight: bolder;"><?php echo ($v["cat_name"]); ?></td>
												<td><?php echo ($v["goods_price"]); ?></td>
												<!--<td><?php echo (htmlspecialchars_decode( $v["goods_desc"])); ?></td>-->
												<td><img src="<?php echo ($v["sm_logo"]); ?>" title="没有图片" style="height:80px;" /></td>
												<td><a class="" href="<?php echo U('Admin/Goods/goods_edit',array('id'=>$v['id']));?>" >Edit</a></td>
												<td><a class="delete" href="javascript:;" data-id="<?php echo ($v["id"]); ?>">Delete</a></td>
