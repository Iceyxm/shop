					...
					<div class="span12">
						...
						<div class="portlet box green">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i><?php echo ($titles["sub"]); ?></div>
							...
							<div class="portlet-body form">
								...
								<form action="" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="attr_name" data-required="1" class="span6 m-wrap" value="<?php echo ($info["attr_name"]); ?>"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select class="span6 m-wrap" name="attr_type" id="attr_type">
												...
												<option value="可选" <?php if('可选' == $info['attr_type']): ?>selected="selected"<?php endif; ?>>可选</option>
												<option value="唯一" <?php if('唯一' == $info['attr_type']): ?>selected="selected"<?php endif; ?>>唯一</option>
											</select>
										</div>
									</div>	
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="attr_option_value" id="a_o_v" <?php if('唯一' == $info['attr_type']): ?>disabled="disabled"<?php endif; ?>><?php echo ((isset($info["attr_option_value"]) && ($info["attr_option_value"] !== ""))?($info["attr_option_value"]):""); ?></textarea>
										</div>
									</div>
	...
	<script>
		...
		jQuery(document).ready(function() {
			...
			$("#attr_type").change(function(){
				var attr_val = $(this).val();//获取下拉框改变后的的value值
				////如果选择的值是唯一，则把下面的文本框 禁用
				if(attr_val == "唯一"){
					$("#a_o_v").val("");//在选择唯一的时候，清除文本框的内容
					$("#a_o_v").attr("disabled","disabled");
				}else{
					//如果选择的是：可选，则去掉禁用的属性
					$("#a_o_v").removeAttr("disabled");
				}
			})
