...
<!-- BEGIN PAGE LEVEL STYLES -->
	...
	<link href="<?php echo C('ADMIN_CSS_PATH');?>jqvmap.css" media="screen" rel="stylesheet" type="text/css" />
	<!-- END PAGE LEVEL STYLES -->
	<link rel="shortcut icon" href="<?php echo C('ADMIN_IMAGE_PATH');?>favicon.ico" />
	<script type="text/javascript" src="<?php echo C('ADMIN_JS_PATH');?>jquery-1.8.3.min.js"></script>
					...
					<div class="portlet box yellow">
						...
						<div class="portlet-body">
							<table class="table table-bordered table-hover">
								...
								<tr>
									<th>用户名</th>
									<td><?php echo ($orderinfo["user_name"]); ?></td>
								</tr>
								<tr>
									<th>订单编号</th>
								...
								<tr>
									<th>支付方式</th>
									<td><?php echo ($paymethods[$orderinfo['order_pay']]); ?></td>
								</tr>
								<tr>
									<th>是否发货</th>
									<td><?php echo ($orderinfo['is_send']=='是' ? "<span class='label label-success'>已发货</span>" : "<span class='label label-danger'>未发货</span>"); ?></td>
								</tr>
								<tr>
									<th>是否付款</th>
									<td><?php echo ($orderinfo['order_status']=='1' ? "<span class='label label-success'>已付款</span>" : "<span class='label label-danger'>未付款</span>"); ?></td>
								</tr>
								<tr>
									<th>发票抬头</th>
									<td><?php echo ($orderinfo['order_fapiao_title']=='0' ? "<span class='label label-success'>个人</span>" : "<span class='label label-info'>公司</span>"); ?></td>
								</tr>
								<tr>
									<th>发票公司</th>
									<td><?php echo ($orderinfo["order_fapiao_company"]); ?></td>
								</tr>
								<tr>
									<th>发票内容</th>
								...
								<tr>
									<th>下单时间</th>
									<td><?php echo (date("Y-m-d H:i:s",$orderinfo["add_time"])); ?></td>
								</tr>
								<tr>
									<th>收货人名称</th>
									<td><?php echo ($orderinfo["cgn_name"]); ?></td>
								</tr>
								<tr>
									<th>收货人地址</th>
									<td><?php echo ($orderinfo["cgn_address"]); ?></td>
								</tr>
								<tr>
									<th>联系电话</th>
									<td><?php echo ($orderinfo["cgn_tel"]); ?></td>
								</tr>
								<tr>
									<th class="hidden-480">邮编</th>
									<td class="hidden-480"><?php echo ($orderinfo["cgn_code"]); ?></td>
								</tr>
								</thead>
							</table>
						...
						<div class="portlet-body">
							<table class="table table-condensed table-hover">
								...
								<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><tr>
										...
										<td><span class="label label-info">￥<?php echo ($v["goods_price"]); ?></span></td>
										<td class="hidden-480"><?php echo ($v["goods_number"]); ?></td>
										<td><span class="label label-warning">￥<?php echo ($v["goods_total_price"]); ?></span></td>
			...
			<div class="row-fluid">
				<div class="span6">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-reorder"></i><?php echo ($orderinfo["cgn_address"]); ?></div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
								<a href="javascript:;" class="reload"></a>
...
<!-- END PAGE LEVEL PLUGINS -->
	...
	<script src="<?php echo C('ADMIN_JS_PATH');?>maps-vector.js"></script>
