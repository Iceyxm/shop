						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										<a href="<?php echo U('Attribute/attr_add',array('type_id'=>I('get.type_id')),false);?>">
											<button id="" class="btn green">属性添加<i class="icon-plus"></i></button>
										</a>
									</div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										<?php if(is_array($lst)): foreach($lst as $key=>$v): ?><tr class="">
												...
												<td><a class="" href="<?php echo U('attr_edit',array('id'=>$v['id']));?>">Edit</a></td>
