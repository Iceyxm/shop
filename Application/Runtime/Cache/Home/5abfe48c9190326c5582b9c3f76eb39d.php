...
<head>
    ...
    <style type="text/css">
        /*顶部导航 topnav*/
        .topnav{width: 100%; height: 80px; background:#efefef url("../images/bg1.png") 0 0  repeat-x;}
        .topnav_right li{float: left; display: inline; height: 80px; line-height: 80px; padding:0 5px;}
...
<div class="topnav">
    <div class="topnav_bd w1210 bc">
        <div class="topnav_left" width="500" height="20">
            <!--<iframe name="weather_inc" style="float: left;" src="http://i.tianqi.com/index.php?c=code&id=48" width="440" height="45" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>-->
            <iframe name="weather_inc" style="float: left;" src="http://i.tianqi.com/index.php?c=code&id=2" width="770" height="70" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"></iframe>
            <!--<iframe name="weather_inc" style="float: left;" src="http://i.tianqi.com/index.php?c=code&id=11" width="500" height="15" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" ></iframe>-->
            <!--<ul style="list-style: none;overflow: hidden;float: left;font-family: 'Microsoft YaHei UI Light';font-size: 18px;">-->
                <!--<li style="float: left;color: #00aeee;"><?php echo ($u_city['province']); ?>&#45;&#45;<?php echo ($u_city['city']); ?>:&nbsp;&nbsp;</li>-->
                <!--<li style="float: left;">&nbsp;&nbsp;<?php echo ($city_weather['weather']); ?>&nbsp;&nbsp;</li>-->
                <!--<li style="float: left;">&nbsp;&nbsp;最低气温：<?php echo ($city_weather['min_tmp']); ?>&nbsp;&nbsp;</li>-->
                <!--<li style="float: left;">&nbsp;&nbsp;最高气温<?php echo ($city_weather['max_tmp']); ?>&nbsp;&nbsp;</li>-->
                <!--<li style="float: left;">&nbsp;&nbsp;<?php echo ($city_weather['ptime']); ?>更新</li>-->
            <!--</ul>-->
        </div>
...
<div class="header w1210 bc mt15">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 首页，不需要添加cat1类 -->
		...
		<div class="goodslist mt10">
			<ul>
				<?php if(is_array($goodsinfo)): foreach($goodsinfo as $key=>$v): ?><li>
						<dl>
							<dt><a href="<?php echo U('detail',array('goods_id'=>$v['id']));?>"><img src="<?php echo ($v["sm_logo"]); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('detail',array('goods_id'=>$v['id']));?>"><?php echo ($v["goods_name"]); ?></a></dt>
							<dd><a href=""><strong>￥<?php echo ($v["goods_price"]); ?></strong></a></dt>
